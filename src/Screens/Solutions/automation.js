            ...
            <main id="main">
                ...
                <div className="col-lg-12" data-aos="fade-up" data-aos-delay="200">
                    <section id="services-cards" className="services-cards">
                        <div className="container" data-aos="fade-up">
                            <div className="section-header">
                                <h2>AUTOMATION, ORCHESTRATION & CODE DEVELOPMENT</h2>
                            </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-xl-12 d-flex align-items-center">
                                                <div className="card-body">
                                                    <p>Need an extra resource to write and validate REST API Integrations?<br />Do your automation scripts require a JavaScript to Python
                                                        conversion?<br /><br /></p>
                                                    <p>Novisync<sup>&reg;</sup> code development resources are primed and ready to address all of your automation needs using multiple disciplines
                                                        of Agile or Waterfall development, phased implementations, and the latest repository integrations. We avoid abstracting the complexity
                                                        of unnecessary layers by using 'simplification with standardization' as our mandate.</p>
                                                    <p>Customized integrations, automation scripts, and orchestration coding that promote datacenter<br />
                                                        REST API &amp; SOAP Frameworks<br />Command Line Interfaces &amp; Shells (CMD, Bash, PowerShell, PowerCLI, etc.)<br />
                                                        Scripting Languages (JavaScript, Ruby, Python, Perl, VBScript, etc.)</p>
