            ...
            <main id="main">
                ...
                <div className="col-lg-12" data-aos="fade-up" data-aos-delay="200">
                    <section id="services-cards" className="services-cards">
                        <div className="container" data-aos="fade-up">
                            <div className="section-header">
                                <h2>BUSINESS DEVELOPMENT & ENTERPRISE MANAGEMENT</h2>
                            </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-xl-12 d-flex align-items-center">
                                                <div className="card-body">
                                                    <p>While the speed of delivery and a quick time to market may be the driving force behind a revenue-generating IT software implementation,
                                                        Novisync<sup>&reg;</sup> understands the benefit of well-planned, cost-effective IT solutions that focus on achieving the perfect balance of
                                                        people, process, and technology. Our business consulting services target the specific gaps that plague the enterprise market,
                                                        changing a highly complex project into a smooth, pleasant experience. <br /><br /><br /><br /><a href="/contact">Learn More...</a></p>
